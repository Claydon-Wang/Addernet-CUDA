...
def conv3x3(in_planes, out_planes, stride=(1, 1)):
    ...
    return Adder2D(in_planes, out_planes, kernel_size=(3, 3), stride=stride, padding=(1, 1), bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=6):
        ...
        # self.avgpool = nn.MaxPool2d(2, stride=1)  # need transform
...
def resnet_test(**kwargs):
    return ResNet(BasicBlock, [1, 1, 2], **kwargs)

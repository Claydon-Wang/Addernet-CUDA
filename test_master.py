...
def main():
    ...
    # print(' * Acc@1_max {top1_max.avg:.3f} Acc@5_max {top5_max.avg:.3f}'
    #     .format(top1=top1_max, top5_max=top5))
...
def validate(val_loader, model):
    ...
    with torch.no_grad():
        for i, (input, target) in enumerate(val_loader):
            ...
            # acc1_max.update(acc1_max[0], input.size(0))
            # acc5_max.update(acc5_max[0], input.size(0))

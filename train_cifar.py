...
data_train = CIFAR10(root='./data', train=True, download=False, transform=transform_train)

# data_test = CIFAR10(args.data,
#                   train=False,
#                   transform=transform_test)
data_test = CIFAR10(root='./data', train=False, download=False, transform=transform_test)

data_train_loader = DataLoader(data_train, batch_size=64, shuffle=True, num_workers=2)
data_test_loader = DataLoader(data_test, batch_size=64, num_workers=0)

net = resnet20().cuda()      #选择nn
